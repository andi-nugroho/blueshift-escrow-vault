...
use crate::{
    AssociatedTokenAccount, Escrow, MintInterface, ProgramAccount, SignerAccount, TokenAccount,
};
...
impl<'a> TryFrom<&'a [AccountInfo]> for Refud<'a> {
    type Error = ProgramError;
